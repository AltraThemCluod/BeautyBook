    ...
    BeautyBook.dateRangePicker = function () {
        if ($('.datepicker').exists()) {
            loadScript(plugin_path + 'daterangepicker/daterangepicker.js', function () {
                ...
                $('input.singledatepicker').attr("placeholder", "dd/mm/yyyy");
                ...
                $('input.previousdatepicker').attr("placeholder", "dd/mm/yyyy");
        ...
        BeautyBook.dateRangePicker = function () {
            if ($('.datepicker').exists()) {
                loadScript(plugin_path + 'daterangepicker/daterangepicker.js', function () {
                    ...
                    $('input.previousdatepickerAppoinment').attr("placeholder", "dd/mm/yyyy");
