...
function BackToButton() {
    debugger;
    if (atob(SalonId) > 0) {
        $('#backToarrow').html(`<a class="btn btn-link" href="/Home/Index"><i class= "bb-chevron-left align-middle" ></i >${Langaugestore.BackToDashboard}</a >`);
    } else {
        debugger;
        $('#backToarrow').html(`<a class="btn btn-link" href="/Salons/SalonsDetails"><i class= "bb-chevron-left align-middle" ></i >${Langaugestore.BackToSalonDetails}</a >`);
    }
    Arrow();
}
