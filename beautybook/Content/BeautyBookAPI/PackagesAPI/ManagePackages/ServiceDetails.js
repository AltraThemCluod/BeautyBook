...
function employeeProfile(employeeId) {
    ...
    if (employeeId > 0) {
        $.ajax({
            type: 'POST',
            url: '' + APIEndPoint + '/api/users/Users_ById?Id=' + employeeId + '',
                                        ...
                                        if (!serviceIds.includes(serviceId) && serviceId > 0) {
                                            ...
                                            serviceName += `
                                                <tr>
                                                    ...
                                                    <td>$${result.Item.UserServices[j].Price}</td>
                                                </tr>
                                            `;
                                        }
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="bg-soft-primary text-primary">
                                                        ${result.Item.UserServices[i].LookUpServicesId == 0 ?
                                                            `${result.Item.UserServices[i].Duration} Min` : `Duration`
                                                        }
                                                    </th>
                                                    <th class="bg-soft-primary text-primary">
                                                        ${result.Item.UserServices[i].LookUpServicesId == 0 ?
                                                            `$${result.Item.UserServices[i].Price}` : `Price`
                                                        }
                                                    </th>
                                                </tr>
                                            </thead>
                ...
                for (i = 0; i < result.Item.AssignToUserAppointments.length; i++) {
                    $('#AssignToAppointmentslist').append(`
                        <tr>
                            ...
                            <td>$${result.Item.AssignToUserAppointments[i].Price == "" || result.Item.AssignToUserAppointments[i].Price == null ? '-' : result.Item.AssignToUserAppointments[i].Price}</td>
                            <td>
