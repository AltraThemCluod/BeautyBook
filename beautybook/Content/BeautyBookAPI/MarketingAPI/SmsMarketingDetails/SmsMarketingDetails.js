...
function addSmsMarketingDetails() {
    ...
    $('#addMarketingDetailsbtnloading').show();
    ...
    SmsMarketing.Gender = $('input[name="genderdetails"]:checked').val() == undefined ? 0 : $('input[name="genderdetails"]:checked').val();

    let CustomerSinceDate = $('#customerSince').val();
    const CustomerSinceArr = CustomerSinceDate.split("-");
    SmsMarketing.CustomerSinceStart = CustomerSinceArr[0] == undefined ? "" : CustomerSinceArr[0];
    SmsMarketing.CustomerSinceEnd = CustomerSinceArr[1] == undefined ? "" : CustomerSinceArr[1];

    let LastVisitDate = $('#lastVisit').val();
    const LastVisitArr = LastVisitDate.split("-");
    SmsMarketing.LastVisitStart = LastVisitArr[0] == undefined ? "" : LastVisitArr[0];
    SmsMarketing.LastVisitEnd = LastVisitArr[1] == undefined ? "" : LastVisitArr[1];
    ...
    SmsMarketing.ServicesId = $('#lookupserviceslist').val().toString();
    SmsMarketing.SmsTemplate = $('#smsTemplate').val();
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#addMarketingDetailsbtn').show();
            $('#addMarketingDetailsbtnloading').hide();
        },
