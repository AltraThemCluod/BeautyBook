        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (i = 0; i < result.Item.UserAppointments.length; i++) {
                    ...
                    if (result.Item.UserAppointments[i].AppointmentServicesList.length > 0) {
                        for (var m = 0; m < result.Item.UserAppointments[i].AppointmentServicesList.length; m++) {
                            sName += `<p class="mb-2">${result.Item.UserAppointments[i].AppointmentServicesList[m].ServiceName == "" || result.Item.UserAppointments[i].AppointmentServicesList[m].ServiceName == null ? '-' : result.Item.UserAppointments[i].AppointmentServicesList[m].ServiceName}</p>`
                            sProvider += `<p class="mb-2">${result.Item.UserAppointments[i].AppointmentServicesList[m].ServiceProvider == "" || result.Item.UserAppointments[i].AppointmentServicesList[m].ServiceProvider == null ? '-' : result.Item.UserAppointments[i].AppointmentServicesList[m].ServiceProvider}</p>`
                            sPrice += `<p class="mb-2">SAR ${result.Item.UserAppointments[i].AppointmentServicesList[m].Price == "" || result.Item.UserAppointments[i].AppointmentServicesList[m].Price == null ? '-' : result.Item.UserAppointments[i].AppointmentServicesList[m].Price.toFixed(2)}</p>`
                        }
                    }
                    ...
                    $('#userAppointmentslist').append(`
                        <tr>
                            ...
                            <td>${sPrice}</td>
                            <td>
                                SAR ${result.Item.UserAppointments[i].TotalPrice == "" || result.Item.UserAppointments[i].TotalPrice == null ? '-' : result.Item.UserAppointments[i].TotalPrice.toFixed(2)}
                            </td>
                            <td>
