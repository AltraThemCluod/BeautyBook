    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.Values.length <= 0) {
                $("#shippingaddresslist").html(`
                <td colspan="100" class="text-center" style="font-size:18px;font-weight:500;margin-left: 279px;">${Langaugestore.NoRecordsFound}</td>
                `);
            } else {
                         ...
                         <div class="col-lg-6 mb-3">
                            <div class="border p-3 rounded">
                                <div class="custom-control custom-radio mb-3">
                                    <input type="radio" class="custom-control-input" id="defaultAddress" name="shipping" checked="">
                                    <label for="defaultAddress" class="custom-control-label d-flex align-items-center">
                                        <span>
