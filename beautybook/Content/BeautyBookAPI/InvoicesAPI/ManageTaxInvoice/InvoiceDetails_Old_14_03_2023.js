            ...
            if (result.Item != null) {
                ...
                for (var s = 0; s < result.Item.OrderSalonData.length; s++) {
                    BuyerAddress += `<address>
                        <b class="text-muted">Buyer Name </b> : ${result.Item.OrderSalonData[s].CustomerName == "" || result.Item.OrderSalonData[s].CustomerName == null ? "-" : result.Item.OrderSalonData[s].CustomerName}<br />
                        <div class="d-flex align-items-start justify-content-start">
                            <span class="mr-1"><b class="text-muted">Address</b> : </span>
                            <span>
                        ...
                        <b class="text-muted">Commercial Register No </b> : ${result.Item.OrderSalonData[s].CommercialRegisterNo == "" || result.Item.OrderSalonData[s].CommercialRegisterNo == null ? "-" : result.Item.OrderSalonData[s].CommercialRegisterNo}<br />
                        <b class="text-muted">VAT Number</b> : ${result.Item.OrderSalonData[s].SalonVATNumber == "" || result.Item.OrderSalonData[s].SalonVATNumber == null ? "-" : result.Item.OrderSalonData[s].SalonVATNumber}<br />
                    </address>`
                }
                ...
                $("#VendorTypeInvoiceDetails").append(`
                    <div class="card p-4 mb-3">
                        ...
                        <div class="invoice-main">
                            ...
                            <hr>
                            <div class="row fs-14" id="invoiceAddressDetails">
                                <div class="col-sm-6 text-sm-left order-sm-1 invoice-payto">
                                   <strong class="fs-20">${Langaugestore.Buyer} : </strong>
                                   <p class="mb-2"></p>
                                   ${BuyerAddress}
                                </div>
                                <div class="col-sm-6 order-sm-0 invoice-invoicedto">
                                    <strong class="fs-20">${Langaugestore.Suppler} : </strong>
                                    <p class="mb-2"></p>
                                    <address>
                                        <b class="text-muted">Seller Name</b> : ${result.Item.VendorCompanyName == "" || result.Item.VendorCompanyName == null ? "" : result.Item.VendorCompanyName}<br />
                                        <div class="d-flex align-items-start justify-content-start">
                                            <span class="mr-1"><b class="text-muted">Address</b> : </span>
                                            <span>
                                        ...
                                        <b class="text-muted">Commercial Register No</b> : ${result.Item.CommercialRegisterNumber == "" || result.Item.CommercialRegisterNumber == null ? "" : result.Item.CommercialRegisterNumber}<br />
                                        <b class="text-muted">VAT Number</b> : ${result.Item.VATNumber == "" || result.Item.VATNumber == null ? "" : result.Item.VATNumber}
                                    </address>
                                </div>
                            </div>
                            <div class="card">
