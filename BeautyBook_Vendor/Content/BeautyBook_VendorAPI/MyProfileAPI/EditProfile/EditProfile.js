...
function editProfileDetails() {
    ...
    $.ajax({
        type: 'POST',
        url:  APIEndPoint + `/api/users/Users_ById?Id=${atob(VendorId)}`,
        ...
        success: function (result) {
            ...
            $('#VendorBankName').val(result.Item.BankName);
            $('#VendorIBANNumber').val(result.Item.IBANNumber);
            $('#VendorVATNumber').val(result.Item.VATNumber);
            $('#CommercialRegisterNo').val(result.Item.CommercialRegisterNumber);
            $('#CompanyName').val(result.Item.VendorCompanyNumber);
...
function editProfile() {
    ...
    formData.append("BankName", $("#VendorBankName").val());
    formData.append("IBANNumber", $("#VendorIBANNumber").val());
    formData.append("VATNumber", $("#VendorVATNumber").val());
    formData.append("CommercialRegisterNumber", $("#CommercialRegisterNo").val());
    formData.append("VendorCompanyNumber", $("#CompanyName").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.Code == 200) {
                ...
                setTimeout(function () {
                    if (result.Item.IsAdminApproved == false) {
        ...
        success: function (result) {
            if (result.Code == 200) {
                ...
                Swal.fire({
                    position: 'center',
                    icon: 'success',
                    title: ''+Langaugestore.VerificationCode+'',
                    showConfirmButton: false,
                    timer: 3000
                })
                setTimeout(function () {
