...
function forgotpasswordEmail() {
    ...
    $.ajax({
        type: 'POST',
        //url: '' + APIEndPoint + "/api/users/Users_Login?Email=" + getUserEmail + "&PasswordHash&DeviceToken&LoginType=" + 3,
        url: `${APIEndPoint}/api/users/Users_Login?Email=${getUserEmail}&PasswordHash=10&DeviceToken=10&LoginType=3&LookUpUserTypeId=5`,
