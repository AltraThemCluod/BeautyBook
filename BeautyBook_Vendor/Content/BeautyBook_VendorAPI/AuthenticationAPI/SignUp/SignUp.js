...
function userSignUp() {
    ...
    SignUpvalue.LookUpUserTypeId = 5;
...
function TermsAndConditions() {
    $.ajax({
        type: 'POST',
        url: '' + APIEndPoint + '/api/termsAndConditions/TermsAndConditions_ById?Id=3',
        headers: { 'Content-Type': 'application/json' },
        dataType: 'json',
        crossDomain: true,
        success: function (result) {
...
function PrivacyPolicy() {
    ...
    $.ajax({
        type: 'POST',
        url: '' + APIEndPoint + '/api/privacyPolicy/PrivacyPolicy_ById?Id=1&Type=2',
        headers: { 'Content-Type': 'application/json' },
        dataType: 'json',
        crossDomain: true,
        async: false,
