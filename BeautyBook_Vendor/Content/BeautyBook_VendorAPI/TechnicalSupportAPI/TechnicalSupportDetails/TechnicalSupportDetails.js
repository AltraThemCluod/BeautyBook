...
function CreateTechnicalTicket() {
    ...
    TechnicalSupport.SalonId = 0;
    TechnicalSupport.UserId = atob(VendorId);
    TechnicalSupport.Discription = btoa(unescape(encodeURIComponent($('#TechnicalSupportDiscription').summernote('code'))));
    TechnicalSupport.UserTypeId = 5;
    TechnicalSupport.CreatedBy = atob(VendorId);
    TechnicalSupport.UpdatedBy = atob(VendorId);
