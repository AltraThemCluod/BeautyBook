...
function GeneratInvoice(OrignalInvoiceNo) {
    debugger;
    window.location.href = `/ManageVendorOrders/InvoiceDetails?OrderId=${OrignalInvoiceNo}`
}

//old code comment 10/03/2023
//for (var s = 0; s < result.Item.OrderSalonData.length; s++) {
//    BuyerAddress += `<address>
//                        ${result.Item.OrderSalonData[s].CustomerName}<br />
//                        ${result.Item.OrderSalonData[s].BillingAddressName}<br />
//                        ${result.Item.OrderSalonData[s].BillingCountryName} ${result.Item.OrderSalonData[s].BillingZipCode}<br />
//                        ${result.Item.OrderSalonData[s].SalonVATNumber}<br />
//                    </address>`
//}
                               ...
                               <div class="w-100 mb-2">
                                    <div class="card-body p-0">
                                        <div class="table-card table-responsive border-none">
                                            <table class="table fs-14 mb-0" id="address_formate">
                                                <thead>
                                                    <tr>
